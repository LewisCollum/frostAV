...
* Front-End: FPV Live Stream & System Statistics
  ...
  [[./figure/snapshots/liveStream.png]]
  ...
  [[./figure/snapshots/stats_combined.png]]
...
* Automation System
  ...
  (see figure [[fig-frameSubject]]), which is a simple object that
  ...
  [[./figure/blocks/block_frameSubject.png]]
